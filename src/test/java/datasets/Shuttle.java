...
// ----------------------------------------------------
@Tag("Shuttle") @DisplayName("Explore Shuttle Dataset")
// ----------------------------------------------------
// Allows you to examine the shuttle dataset. For more
...
class Shuttle {
    ...
    private static Path plotFolder = PLOTS_FOLDER.resolve("shuttle");
...
//        //
//        // =======> J48 TREE
//        //      Precision       |     KS-Distance      |     Correlation      |  NumDims  |       Dimensions        |
//        // ----------------------------------------------------------------------------------------------------------
//        //  0.9998777929405055  |  0.6433062697461056  |  0.2164971891532879  |        3  |  [dim00, dim01, dim08]  |
//        //
//        //
//        // =======> NAIVE BAYES
//        //      Precision       |     KS-Distance      |     Correlation      |  NumDims  |              Dimensions               |
//        // ------------------------------------------------------------------------------------------------------------------------
//        //  0.9965578344909057  |  0.6493576586764567  |  0.2683429869260747  |        5  |  [dim00, dim01, dim02, dim06, dim08]  |
//        //
//        //
//        // =======> K NEAREST NEIGHBOUR
//        //
//    void bestSetOfFeaturesShuttle() {
//        for (Classifiers classifier : Classifiers.values()) {
//            var results = exploreDataset(SHUTTLE, classifier);
